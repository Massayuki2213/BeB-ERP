...
  valor: number;
  itens: any[];
  // CAMPO NECESSÁRIO PARA INFORMAÇÕES DO VEÍCULO E OBS
  descricao?: string; 
}
...
        valor: venda.valorTotal || 0,
        descricao: venda.descricao || '', // Mapeando a descrição do BACKEND
...
                formaPagamento: notaSelecionada.tipo,
                descricao: notaSelecionada.descricao, // Adicionado
                itens: notaSelecionada.itens.map((item: any) => {
                    // Tenta usar o preco/qtd do item se disponível (se o backend retornar itensVendas mapeados corretamente)
